...
import Task3 from "../../component/Pagination/Task3";
import AGGrid from "../../component/AG-Grid/AG-Grid.component";
...
function ProductsPage({ currentUser }) {
  const token = currentUser.userAuth.token;
  ...
  return (
    <div>
      ...
      {products.products ? (
        <Task3 pro={products.products} load={loading} />
      ) : (
        <h4>در حال برقراری ارتباط ...</h4>
      )}
      <AGGrid pro={products.products} />
    </div>
  );
}
