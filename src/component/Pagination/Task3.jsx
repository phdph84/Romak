...
import "./Task3.styles.css";
function Task3({ pro, load }) {
  //   const product = [
  //     {
  //       id: 1,
  //       title: "iPhone 9",
  ...
  const howManyPages = Math.ceil(pro.length / productsPerPage);

  return (
    <div className="task3Container">
      <h4 className="headerTask3">لیست محصولات - استفاده از Pagination</h4>
